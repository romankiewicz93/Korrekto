                ...
                <form method="POST" action="/material" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" class="border border-gray-200 rounded p-2 w-full" name="name"
                            placeholder="Beispiel: VODCAST" value="{{ old('name') }}">
                        @error('name')
                    ...
                    <div class="mb-6">
                        ...
                        <textarea class="border border-gray-200 rounded p-2 w-full" name="description" rows="10"
                            placeholder="Beschreibe zum Beispiel den Zweck der Kursmaterialien, oder welche Form dieser haben wird Schriftform, AUDIO-Material, VIDEO-Material"
